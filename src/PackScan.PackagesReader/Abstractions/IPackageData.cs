...
public interface IPackageData
{
    ...
    /// </remarks>
    IPackageVersionData Version { get; }
    ...
    /// <summary>
    /// Specifyies whether the package is be marked as a development-only-dependency, which prevents the package from being included as a dependency in other packages.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    IPackageReleaseNotesData ReleaseNotes { get; }
    ...
    /// </remarks>
    IPackageRepositoryData Repository { get; }
    ...
    /// </remarks>
    IPackageLicenseData License { get; }
